...
* Property switcher respected by every widget
    ...
    'data': [
        ...
        'data/rcloud_ui_branding.xml',
        'views/rcloud_ui_views.xml',
        'views/rcloud_ui_assets.xml',
    ],
    'assets': {
        'web.assets_backend': [
